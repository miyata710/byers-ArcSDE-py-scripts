...
that end with .AE, .EA, or .EAE. Drafters needed extractions with far less necessary feature classes than in typical
CAD extractions. Otherwise, this script performs in the same manner as the regular CAD extraction scripts. 
'''
